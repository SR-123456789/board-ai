        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl font-bold">Board AI にログイン</CardTitle>
                    <CardDescription>アカウントを作成またはログインして続行</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-background px-2 text-muted-foreground">またはメールアドレス</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-4">
                        ...
                        {message && (
                            <div className={`text-sm p-2 rounded ${message.type === 'error' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'}`}>
                                {message.text}
                            </div>
                        )}
